      ...
      <div className={styles.checkoutContainer}>
        ...
        {item && (
          <>
            ...
            <h3>Price: <span style={{ color: '#fd7e14', fontWeight: 'bold' }}>&#8358;{item.price}</span></h3>
            <p>Review: <span style={{ color: '#FFD700' }}>★★★</span></p>
            <img src={item.image} style={{width:'100px',borderBottom:'2px solid #fd7e14',borderRadius:'5px'}} alt="Fire Icon" />
          </>
        )}
