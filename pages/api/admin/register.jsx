...
async function sendWelcomeEmail(name, email) {
  ...
  // Email options
const mailOptions = {
  from: '"comicnova.com" <noreply@useditem.com>', // sender address
  to: email, // list of receivers
  subject: 'Welcome to comicnova.com!', // Subject line
  text: `Hello ${name}, welcome to comicnova.com! We are thrilled to have you with us.`, // plain text body
  html: `
    <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.5;">
      <div style="text-align: center; padding: 20px;">
        <img src="https://comicnova.vercel.app/logo/imageone.jpeg" alt="comicnova.com Logo" style="width: 150px;"/>
      </div>
      <p>Hello ${name},</p>
      <p>Welcome to <strong>comicnova.com</strong>! We are absolutely thrilled to have you join our community.</p>
      ...
      <p>Best regards,</p>
      <p>The <strong>comicnova.com</strong> Team</p>
