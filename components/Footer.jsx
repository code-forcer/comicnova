    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.container}>
        <div className={styles.socialIcons}>
         ...
         <img className={styles.logo} src="/radix/comic.svg" alt="" srcset="" />
        <p className={styles.footerText}>© 2024 <span style={{color:'#fd7e14'}}>comicnova.net </span> - All Rights Reserved, <a href="/policy" target="_blank" style={{color:'#0ea',textDecoration:'underline'}}>Our-policy</a></p>
      </div>
    </footer>
  );
};
